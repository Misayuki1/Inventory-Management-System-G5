...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseProducts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('add.product')); ?>">New Product</a>
                                    <a class="nav-link" href="<?php echo e(route('all.product')); ?>">Stock Report</a>
                                    <a class="nav-link" href="<?php echo e(route('available.products')); ?>">Available Products</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseOrders" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('new.order')); ?>">New Order</a>
                                </nav>
                            </div>
                            <div class="collapse" id="collapseOrders" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('all.orders')); ?>">Orders List</a>
                                </nav>
                            </div>
                            <div class="collapse" id="collapseOrders" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('pending.orders')); ?>">Pending Orders</a>
                                </nav>
                            </div>
                            <div class="collapse" id="collapseOrders" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('delivered.orders')); ?>">Delivered Orders</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseInvoice" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('new.invoice')); ?>">New Invoice</a>
                                    <a class="nav-link" href="<?php echo e(route('all.invoices')); ?>">Invoices List</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseAuthentication" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('add.customer')); ?>">New Customer</a>
                                </nav>
                            </div>
                            <div class="collapse" id="collapseAuthentication" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('all.customers')); ?>">Customers List</a>
                                </nav>
                            </div>
        ...
        <script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script> -->
         <!-- <script src="<?php echo e(asset('backend')); ?>/assets/demo/datatables-demo.js"></script>  -->
<!-- 
...
<?php /**PATH C:\Users\Albri\OneDrive\Documents\Inventory_Management_System\resources\views/layouts/admin_master.blade.php ENDPATH**/ ?>